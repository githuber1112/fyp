...
const ProfileDetails = () => {
    ...
    const { displayName : currentDisplayName, userAddress: currentAddress,  email, id } = currentUser;
    ...
    const handleFormSubmit = (e) => {
        e.preventDefault()
      dispatch(updateUserInfoStart({id,userAddress,displayName,phoneNumber}));
    }
